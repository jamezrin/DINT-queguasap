...
INSERT INTO usuarios (telefono, nombre, contrasena, conectado, color_fondo, estado) VALUES ("901234536", "Iñaki", "$2y$10$d2.G3WgipvpjqtKn5Lm3N.txF3AwdZiYvSL7qPFxlBbFpRdRknr6W", false, "#0000FF", "Hello there I am using queguasap");
INSERT INTO usuarios (telefono, nombre, contrasena, conectado, color_fondo, estado) VALUES ("993726392", "Jaime", "$2y$10$d2.G3WgipvpjqtKn5Lm3N.txF3AwdZiYvSL7qPFxlBbFpRdRknr6W", false, "#317F43", "Hello there I am using queguasap");
INSERT INTO usuarios (telefono, nombre, contrasena, conectado, color_fondo, estado) VALUES ("846378284", "Robert", "$2y$10$d2.G3WgipvpjqtKn5Lm3N.txF3AwdZiYvSL7qPFxlBbFpRdRknr6W", true, "#317F43", "Hello there I am using queguasap");
INSERT INTO usuarios (telefono, nombre, contrasena, conectado, color_fondo, estado) VALUES ("846264826", "Miguel", "$2y$10$d2.G3WgipvpjqtKn5Lm3N.txF3AwdZiYvSL7qPFxlBbFpRdRknr6W", false, "#317F43", "Hello there I am using queguasap");
INSERT INTO usuarios (telefono, nombre, contrasena, conectado, color_fondo, estado) VALUES ("946589467", "Alex", "$2y$10$d2.G3WgipvpjqtKn5Lm3N.txF3AwdZiYvSL7qPFxlBbFpRdRknr6W", false, "#317F43", "Hello there I am using queguasap");
INSERT INTO usuarios (telefono, nombre, contrasena, conectado, color_fondo, estado) VALUES ("957355483", "Hector", "$2y$10$d2.G3WgipvpjqtKn5Lm3N.txF3AwdZiYvSL7qPFxlBbFpRdRknr6W", true, "#317F43", "Hello there I am using queguasap");
